...
type ProfileCardStyle = React.CSSProperties & {
  "--icon"?: string;
  "--grain"?: string;
...
const DEFAULT_INNER_GRADIENT =
  "linear-gradient(145deg, var(--palette1) 0%, var(--palette5) 100%)"
  // "linear-gradient(145deg, rgba(246,217,146,0.65) 0%, rgba(246,161,146,0.35) 100%)"
  // "linear-gradient(145deg, rgba(246,217,146,0.65) 0%, rgba(246,161,146,0.2) 40%, rgba(0,0,0,0.25) 100%)"
  // "linear-gradient(145deg, rgba(246,217,146,0.7) 0%, rgba(100,160,150,0.25) 100%)"
  ;
